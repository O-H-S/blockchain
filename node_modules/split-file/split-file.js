 ...
 * @returns {Promise}
 */
SplitFile.prototype.splitFile = function(file, parts, path) 
{
    var self = this;
    ...
    return Promise.promisify(fs.stat)(file).then(function (stat) {
        ...
        return self.__splitFile(file, partInfo, path);
    });
};
 ...
 * @returns {Promise}
 */
SplitFile.prototype.__splitFile = function (file, partInfo, path) {
    ...
    return Promise.mapSeries(partInfo, function (info) {
        return new Promise(function (resolve, reject) {
			...
			var fileName = pathMd.basename(file);
            var partName = path + fileName + '.sf-part' + partNumber;
